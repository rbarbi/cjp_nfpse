function filtrarUsuario(){
	...
	fonteDados.sendRequest("m=acesso&admin=1&a=SysUsuario.action&acao=doListarUsuarios&startIndex=0&results=5&filtro=" + filtro,tabela.onDataReturnInitializeTable, tabela);		
...
function criarTabela(){
	...
	var consulta = function (state,dt) {
		return "m=acesso&admin=1&a=SysUsuario.action&acao=doListarUsuarios&startIndex=" + state.pagination.recordOffset +
	...
	var myTableConfig = {
		initialRequest         : 'm=acesso&admin=1&a=SysUsuario.action&acao=doListarUsuarios&startIndex=0&results=0',
		...
		switch (oArgs.event.target.id){
			...
			case "excluir":{
				...
				var handleSim = function() {
					...
					var sUrl = "index.php";
					var postData = "m=acesso&admin=1&a=SysUsuario.action&acao=doDelUsuario&oid="+record.getData().id;
