...
gama3.form.AssociationLista = Ext.extend(Ext.Panel, {
    ...
    initComponent: function()
    {
        ...
        gama3.form.AssociationLista.superclass.initComponent.apply(this, arguments);
    ...
    onRender: function()
    {
        gama3.form.AssociationLista.superclass.onRender.apply(this, arguments);
        //Redimensiona GRID's
        this.resizeGrids();
    ...
    onShow: function()
    {
        gama3.form.AssociationLista.superclass.onShow.apply(this, arguments);
        this.loadStores();
    },
    ...
    createGridUnlinked: function()
    {
        ...
        this.gridUnlinked = new Ext.grid.GridPanel(this.unlinked);
    ...
    createGridLinked: function()
    {
        ...
        this.gridLinked = new Ext.grid.GridPanel(this.linked);
    },
