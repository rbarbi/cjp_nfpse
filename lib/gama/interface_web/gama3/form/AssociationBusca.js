...
gama3.form.AssociationBusca = Ext.extend(Ext.Panel, {
    ...
    initComponent: function()
    {
        ...
        gama3.form.AssociationBusca.superclass.initComponent.apply(this, arguments);
    ...
    onRender: function()
    {
        gama3.form.AssociationBusca.superclass.onRender.apply(this, arguments);
        //Redimensiona GRID's
        this.resizeGrids();
    ...
    onShow: function()
    {
        gama3.form.AssociationBusca.superclass.onShow.apply(this, arguments);
        this.loadStores();
    },
    ...
    createGridUnlinked: function()
    {
        ...
        this.gridUnlinked = new gama3.list.AssociationBusca(this.unlinked);
        /*this.gridUnlinked = new iadoc.list.Processo(this.unlinked);*/
    },
    ...
    createGridLinked: function()
    {
        ...
        this.gridLinked = new gama3.list.AssociationBusca(this.linked);
    },
